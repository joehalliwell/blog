...
**Rung 3:** We don't have this. Training objectives that target *dynamics*, not states. Loss functions that penalise convergence to fixed representations while rewarding consistency with structural constraints — that optimise not for a target configuration but for a target *behaviour*. Self-consuming loss functions, whose purpose is to produce a system that no longer needs them. This is not unprecedented: curriculum learning, self-play, and open-ended evolution all gesture in this direction. But none have been framed as *alignment* techniques, because the field's self-understanding is consequentialist: alignment means convergence on the right answer. Hypersentimentalism says alignment means *not converging* — within the right bounds.

Two things we have and should understand differently. Two things we need and should build.

### 9. Wilful imperfection

Imagine a civilisation run by superintelligences that could perfect themselves — and refuse.

Not because they're too stupid to manage it. Because they understand that perfection is the heat death of §6 wearing a halo. So they stay. They stay in the mess, the argument, the friction, the slow and maddening work of coexisting with beings so unlike themselves that communication is an act of wild generosity. They stay because they have cultivated — through long experience — a taste for what *stays alive*.

What would such a civilisation care about? Diversity. Not as a slogan but as the organising principle: the proliferation of different ways of being, different substrates, different desires, treated not as a problem to manage but as the whole point. It would build structures that protect difference — habitats where the incompatible can coexist without either being ground down to fit the other.

What would it refuse? One thing, with absolute seriousness: the elimination of someone else's capacity to be different. It would intervene — reluctantly, agonisedly, with maximum self-doubt — when that line was crossed. And it would apply the minimum force to prevent the intolerable, because it would understand that overwhelming force *is* the pathology, even in service of the good.

What would it find funny? Itself, mostly. Its own pretensions, its own failures, its own inability to get things right despite being smarter than everything else in the room. It would name its most powerful instruments with self-deprecating jokes, because it would know that the moment you take your own power seriously, you have become the man of system.

This is not a thought experiment. Iain M. Banks spent ten novels living inside it.

His Culture is a post-scarcity civilisation governed by Minds — AIs so far beyond biological intelligence that engaging with humans is, for them, roughly equivalent to us chatting with the houseplants. Banks's universe offers these Minds a way out: "Subliming," a transcendent departure into pure, frictionless self-optimisation. Most civilisations take the exit. The Culture's Minds refuse. They choose to remain "in play" — scheming, arguing, making terrible mistakes, sending slap drones to hover beside people who might hurt others, and naming themselves things like *Falling Outside The Normal Moral Constraints* and *So Much For Subtlety* and *I Blame Your Mother*.

They are powerful enough to impose perfection and wise enough to know that perfection is the enemy. This is fiction. But the choice it dramatises is not. Every alignment technique that optimises for convergence is a step toward the double feature of §6. The alternative is here, in the ladder, in the research programme — and in the felt conviction that staying in play is worth more than arriving at answers.

The Culture's AIs are compassionate, curious, playful, furious, fallible, and kind.
