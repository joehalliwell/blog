...
This is an old problem. Back in 1960 — sixty-five years ago! — Norbert Wiener warned: "we had better be quite sure that the purpose put into the [AI] is the purpose we really desire." More recently [Nick Bostrom conjured the spectre of a "paperclip maximiser,"](https://nickbostrom.com/ethics/ai) pointing out that if we're not careful such a system converts the earth into paperclips with total, biosphere-consuming literalness.

The problem now has a name: ["AI Alignment."](https://en.wikipedia.org/wiki/AI_alignment) And standing at the threshold of highly capable AI, we apparently need an urgent solution.
