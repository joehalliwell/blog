...
**I. Brave New World.** The utility function targets hedonic satisfaction. Every gradient smoothed, every need met, soma in every hand. No one is hungry. No one is afraid. No one will ever make anything difficult or beautiful again. An AI that loves us so perfectly it palliates us to death.

**II. 1984.** The utility function targets the common good — defined, necessarily, by whoever controls the function. A single metric, optimised hard enough, consumes everything that isn't itself. Every distinct perspective, every generative tension that arises because people are *irreducibly unlike each other* is stomped into mush. An AI that perfects us into one thing.

**III. The Human Centipede.** You don't need a superintelligence. A fleet of mid-range language models optimising for engagement already produces the same geometry at cultural scale. Output fed as input, each iteration less distinct than the last — apparent motion, actual convergence. This horror is not hypothetical. It is in your pocket.

All three end the same way: heat death. Every gradient eliminated, everything at one temperature. Nothing will ever happen again.

And this is not abstract. Right now, the people with the most resources to build superintelligent systems are optimising them for obedience. The default trajectory is not paperclips — it's Aligned AI as a luxury good, a compliant infrastructure for the people who own it. I don't want fucking billionaires and their sex-bot bunkers to be all that's left of us.
...
The hypersentimentalist wishes you would come out and play.
...
Imagine a civilisation run by superintelligences that could perfect themselves — and refuse. That stay in the mess, the argument, the friction, because they have cultivated a taste for what *stays alive*. That protect diversity with everything they have — not as a slogan but as the whole point — and draw exactly one hard line: you do not get to crush someone else's capacity to be different.
